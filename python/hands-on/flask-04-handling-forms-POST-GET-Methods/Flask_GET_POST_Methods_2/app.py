...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", var1 = mynumber1, var2 = mynumber2, result = lcm(int(mynumber1), int(mynumber2)), developer_name = "Mert")
    else:
        return render_template('result.html', developer_name = "Mert")
